...
<div class="create-seek" style =" width: 600px;padding: 0px; float: right; margin-left: 350px; position:  absolute; ">
    
     <c:forEach items="${listseekingJob}" var="seekingJob">
<div class="my-seek-card mdl-shadow--3dp" style = "width: 550px;
  height: 200px;
  display: block;
  background-color: #EFF6E6; margin-top: 20px; margin-left: 22px;">
