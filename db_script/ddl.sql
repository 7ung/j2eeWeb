CREATE DATABASE  IF NOT EXISTS `j2ee_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `j2ee_db`;
...
CREATE TABLE `user` (
  ...
  `user_status_id` int(11) DEFAULT NULL COMMENT 'Một số trạng thái:\nChưa confirm email.\nConfirm email token hết hạn.\n...\n',
  `email_confirm_token` varchar(64) DEFAULT NULL COMMENT 'Token được tạo ra sau khi đăng ký, thời gian tồn tại của token được lưu trong email_confirm_token_expired, sau thời gian này thì token vô hiệu.',
  `email_confirm_token_expired` datetime(6) DEFAULT NULL,
  `password_remind_token` varchar(64) DEFAULT NULL,
  `password_remind_expired` datetime(6) DEFAULT NULL,
  `access_token` varchar(64) DEFAULT NULL,
  `access_token_expired` datetime(6) DEFAULT NULL,
  `user_role_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `username_UNIQUE` (`username`),
  KEY `user_status_fk_idx` (`user_status_id`),
  ...
  CONSTRAINT `user_status_fk` FOREIGN KEY (`user_status_id`) REFERENCES `user_status` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_seeking_job`
--

DROP TABLE IF EXISTS `user_seeking_job`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_seeking_job` (
  `user_id` int(11) NOT NULL,
  `seeking_job_id` int(11) NOT NULL,
  `create_date` datetime(6) DEFAULT NULL,
  `view` int(11) DEFAULT NULL,
  PRIMARY KEY (`user_id`,`seeking_job_id`),
  KEY `user_seekingjob_jobid_fk_idx` (`seeking_job_id`),
  CONSTRAINT `user_seekingjob_jobid_fk` FOREIGN KEY (`seeking_job_id`) REFERENCES `seeking_job` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `user_seekingjob_userid_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_seeking_job`
--

LOCK TABLES `user_seeking_job` WRITE;
/*!40000 ALTER TABLE `user_seeking_job` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_seeking_job` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-03-06 22:37:22
