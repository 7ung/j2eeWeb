...
INSERT INTO `access_token` VALUES (20,'a377990d91bc8345c51083415a06dca5',1493072230,9);
...
INSERT INTO `post_tag` VALUES (30,5),(31,5),(30,19),(31,20),(31,21);
...
INSERT INTO `profile` VALUES (1,'David Jone','1990-04-04 00:00:00.000000','male','England',NULL,NULL,NULL,NULL,9);
...
INSERT INTO `subject` VALUES (3,'1','Hướng dẫn viết Web Service bằng Spring MVC',NULL,1492581335,0,9),(4,'2','Jquery - javascript dễ dàng hơn bao giờ hết',NULL,1492581353,0,9),(5,'3','Series những thằng nguy hiểm nhất hành tinh',NULL,1492581368,0,10),(6,'4','bemp bemp',NULL,1492581384,0,10),(7,'5','booom booom',NULL,1492581412,0,10),(8,'8','Series những thằng nguy hiểm nhất hành tinh','',1492608659,0,9),(9,'9','Bleach OST','',1492930017,0,9),(12,'c','Some kind of music','',1492930626,0,9);
...
INSERT INTO `tag` VALUES (2,'1','php'),(3,'2','seo'),(4,'3','python'),(5,'4','java'),(6,'5','angularjs'),(7,'6','magento'),(8,'7','ios'),(9,'8','lips'),(10,'9','c++'),(11,'a','c#'),(12,'b','mysql'),(13,'c','sql server'),(14,'d','j2ee'),(15,'e','scala'),(16,'f','android'),(17,'10','regex'),(19,'13','lyric'),(20,'14','spring'),(21,'15','web service');
...
-- Dump completed on 2017-04-25  0:19:42
